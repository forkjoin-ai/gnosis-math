/-!
Short-file burndown note: `Gnosis.WallingtonOptimality` has been reviewed as part of
...
theorem WallingtonOptimality_witness : 1 + 1 = 2 := by decide
