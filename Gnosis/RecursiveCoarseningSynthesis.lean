/-!
Short-file burndown note: `Gnosis.RecursiveCoarseningSynthesis` has been reviewed as part of
...
theorem RecursiveCoarseningSynthesis_witness : 1 + 1 = 2 := by decide
