...
import Gnosis.ManifoldLensingEffect
import Gnosis.ManifoldOneWayMirror
...
Imports `Gnosis.BraidedTower`, `Gnosis.ManifoldHorizonEffect`,
`Gnosis.ManifoldLensingEffect`, `Gnosis.ManifoldOneWayMirror`,
`Gnosis.ManifoldHigherClosures`. Zero `sorry`, zero new `axiom`.
-/

namespace Gnosis
namespace ManifoldForkRaceFoldUniversal

open Gnosis.ManifoldHorizonEffect (tritonStretch)
open Gnosis.ManifoldHigherClosures (closureChain closure_chain_step_alt)
...
end ManifoldForkRaceFoldUniversal
end Gnosis
