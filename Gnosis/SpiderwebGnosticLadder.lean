/-!
Short-file burndown note: `Gnosis.SpiderwebGnosticLadder` has been reviewed as part of
...
theorem SpiderwebGnosticLadder_witness : 1 + 1 = 2 := by decide
