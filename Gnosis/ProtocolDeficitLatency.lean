/-!
Short-file burndown note: `Gnosis.ProtocolDeficitLatency` has been reviewed as part of
...
theorem ProtocolDeficitLatency_witness : 1 + 1 = 2 := by decide
