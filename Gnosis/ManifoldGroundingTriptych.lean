...
import Gnosis.ManifoldTripleAnchor10
...
`Gnosis.ManifoldTripleAnchor10`, `Gnosis.BraidedTower`. Zero
`sorry`, zero new `axiom`.
-/

namespace Gnosis
namespace ManifoldGroundingTriptych
