/-!
Short-file burndown note: `Gnosis.ThermodynamicTracedMonoidal` has been reviewed as part of
...
theorem ThermodynamicTracedMonoidal_witness : 1 + 1 = 2 := by decide
