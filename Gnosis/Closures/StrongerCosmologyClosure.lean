/-!
Short-file burndown note: `Gnosis.Closures.StrongerCosmologyClosure` has been reviewed as part of
...
theorem StrongerCosmologyClosure_witness : 1 + 1 = 2 := by decide
