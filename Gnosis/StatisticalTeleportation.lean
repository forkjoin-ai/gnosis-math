...
/-!
Short-file burndown note: `Gnosis.StatisticalTeleportation` has been reviewed as part of
...
theorem StatisticalTeleportation_witness : 1 + 1 = 2 := by decide
