...
/-!
Short-file burndown note: `Gnosis.Semantic.SemanticCompatibility` has been reviewed as part of
...
theorem SemanticCompatibility_witness : 1 + 1 = 2 := by decide
