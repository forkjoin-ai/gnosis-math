/-!
Short-file burndown note: `Gnosis.RaceWinnerPredictions` has been reviewed as part of
...
theorem RaceWinnerPredictions_witness : 1 + 1 = 2 := by decide
