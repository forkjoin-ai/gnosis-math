...
/-!
Short-file burndown note: `Gnosis.StateDependentQueueFamilies` has been reviewed as part of
...
theorem StateDependentQueueFamilies_witness : 1 + 1 = 2 := by decide
