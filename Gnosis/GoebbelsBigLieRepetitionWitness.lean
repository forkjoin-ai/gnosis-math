/-
  GoebbelsBigLieRepetitionWitness.lean
  ===================================

  **Repository stance (read first):** this file **records** **propaganda** **mechanics**
...
namespace GoebbelsBigLieRepetitionWitness
...
end GoebbelsBigLieRepetitionWitness
