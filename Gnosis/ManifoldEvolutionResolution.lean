...
`Gnosis.ManifoldOneWayMirror`. Zero `sorry`, zero new `axiom`.
-/

namespace Gnosis
namespace ManifoldEvolutionResolution

open Gnosis.BraidedTower (towerPhaseCount)
open Gnosis.ManifoldOneWayMirror (carrierBandwidth)
...
end ManifoldEvolutionResolution
end Gnosis
