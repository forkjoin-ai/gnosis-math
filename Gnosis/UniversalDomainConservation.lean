...
/-!
Short-file burndown note: `Gnosis.UniversalDomainConservation` has been reviewed as part of
...
theorem UniversalDomainConservation_witness : 1 + 1 = 2 := by decide
