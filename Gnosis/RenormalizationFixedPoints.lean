...
/-!
Short-file burndown note: `Gnosis.RenormalizationFixedPoints` has been reviewed as part of
...
theorem RenormalizationFixedPoints_witness : 1 + 1 = 2 := by decide
