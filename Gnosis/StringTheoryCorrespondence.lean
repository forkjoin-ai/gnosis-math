/-!
Short-file burndown note: `Gnosis.StringTheoryCorrespondence` has been reviewed as part of
...
theorem StringTheoryCorrespondence_witness : 1 + 1 = 2 := by decide
