...
theorem dewey_310_statistics (data _point smoothing : Nat) (h: smoothing < data) : smoothing < data := by omega
...
theorem dewey_360_social_deadlocks (_problems resolution : Nat) (h: resolution = 0) : resolution = 0 := by omega
