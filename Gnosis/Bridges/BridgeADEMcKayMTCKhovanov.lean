...
/-
  ...
  Sibling oleans must exist:
      lake build Gnosis.ADEMcKayCorrespondence
      lake build Gnosis.ReshetikhinTuraev3DTQFT
      lake build Gnosis.KhovanovCategorifiesJones
      lake build Gnosis.DynkinCoxeterClassification
