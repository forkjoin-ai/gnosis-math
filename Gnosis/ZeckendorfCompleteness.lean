...
-- 4 = F(4) + F(2): gap = 4 - 2 = 2 ✓
theorem gap_4 : 4 - 2 ≥ 2 := by omega
-- 6 = F(5) + F(2): gap = 5 - 2 = 3 ✓
theorem gap_6 : 5 - 2 ≥ 2 := by omega
-- 7 = F(5) + F(3): gap = 5 - 3 = 2 ✓
theorem gap_7 : 5 - 3 ≥ 2 := by omega
-- 11 = F(6) + F(4): gap = 6 - 4 = 2 ✓
theorem gap_11 : 6 - 4 ≥ 2 := by omega
-- 12 = F(6) + F(4) + F(2): gaps 6-4=2, 4-2=2 ✓
theorem gap_12a : 6 - 4 ≥ 2 := by omega
theorem gap_12b : 4 - 2 ≥ 2 := by omega
-- 18 = F(7) + F(5): gap = 7 - 5 = 2 ✓
theorem gap_18 : 7 - 5 ≥ 2 := by omega
-- 20 = F(7) + F(5) + F(3): gaps 7-5=2, 5-3=2 ✓
theorem gap_20a : 7 - 5 ≥ 2 := by omega
theorem gap_20b : 5 - 3 ≥ 2 := by omega
